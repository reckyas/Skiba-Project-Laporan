				...
				<tbody>
					<?php $i= 1; foreach ($data->result() as $siswa): ?>
						<tr>
							...
							<td>
								<button class="btn btn-warning" onclick="editSiswaById(<?php echo $siswa->siswa_id; ?>)" data-toggle="modal" data-target="#editSiswa"><i class="fa fa-edit"></i></button>
								<button class="btn btn-danger" onclick="hapusSiswaById(<?php echo $siswa->siswa_id; ?>)"><i class="fa fa-trash"></i></button>
							</td>
						</tr>
					<?php endforeach ?>
				</tbody>
